...
tmux set -g mode-style "fg=${THEME[background]},bg=${THEME[bblue]}"
...
tmux set -g pane-active-border-style "fg=${THEME[bpurple]},bold"
...
#[fg=${THEME[purple]},bg=default]\
#[fg=${THEME[foreground]},bg=${THEME[purple]},bold] \
#{?client_prefix,󰠠 ,󰤂 }\
#[bold,nodim]#S "
...
right_status="\
#[fg=${THEME[ghgreen]},bg=${THEME[black]}]$git_status#[fg=${THEME[ghpurple]},bg=${THEME[black]}]$wb_git_status#[fg=${THEME[ghred]},bg=${THEME[black]}]$battery_status#[fg=${THEME[ghyellow]},bg=${THEME[black]}]$date_and_time#[fg=${THEME[purple]},bg=default]"
